...
const MessageBubble = ({ message }) => {
  ...
  return (
    ...
    >
      ...
      >
        {message.text && !(message.type === 'comparison' && message.comparisonData) && (
        ...
        {!isUser && (message.analysisData || message.comparisonData || message.newsData) && (
          <ExportMenu targetRefId={`bubble-${message.id}`} />
        )}
