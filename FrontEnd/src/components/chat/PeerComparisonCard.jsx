  ...
  return (
    ...
    >
      <div className="flex items-center gap-2 mb-4 border-b border-white/10 pb-3">
        ...
        <h3 className="text-sm font-bold text-white tracking-tight">Peer Comparison</h3>
      </div>
      ...
      {data.text_summary && (
        <div className="mt-4 pt-3 border-t border-white/5">
          <p className="text-xs text-zinc-400 leading-relaxed bg-zinc-950 p-3 rounded-xl border border-white/5">
            {data.text_summary}
          </p>
        </div>
      )}
