...
const ForecastCard = ({ data }) => {
    ...
    return (
      <div className="mb-4">
        <div className="flex justify-between text-xs mb-1.5">
          ...
          <span className="font-semibold text-zinc-800 dark:text-zinc-200">{target.toFixed(2)}</span>
        </div>
        <div className="relative h-2 bg-gray-50 dark:bg-zinc-950 rounded-full overflow-hidden border border-black/5 dark:border-white/5">
          {/* Target marker */}
          <div 
  ...
  return (
    ...
    >
      <div className="flex items-center justify-between mb-5 border-b border-black/10 dark:border-white/10 pb-3">
        <div className="flex items-center gap-2">
          <FiTarget className="text-indigo-400" />
          <h3 className="text-sm font-bold text-zinc-900 dark:text-white tracking-tight">Price Forecast</h3>
        </div>
